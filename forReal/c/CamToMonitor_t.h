#ifndef __CLASS_CAMTOMONITOR_T_HEADER
#define __CLASS_CAMTOMONITOR_T_HEADER

struct CamToMonitor_t_ClassStruct {
  struct java_lang_Object_ClassStruct *super;
  struct CamToMonitor_t_MethodTblStruct *methodTbl;
...
typedef GC_STRUCT_BEGIN(CamToMonitor_t_ClassStatic)
  /* static fields go here, from this class and its ancestors */
GC_STRUCT_END(CamToMonitor_t_ClassStatic) CamToMonitor_t_ClassStatic;

typedef GC_STRUCT_BEGIN(CamToMonitor_t)
  GC_STRUCT_VAR(struct CamToMonitor_t_ClassStruct *,class);
  ...
  volatile GC_STRUCT_REF(Monitor,_CamToMonitor_t_mon);
GC_STRUCT_END(CamToMonitor_t) CamToMonitor_t;

struct CamToMonitor_t_MethodTblStruct {
  ...
  void (*run)(void **__eFlag__, GC_PARAM(CamToMonitor_t,this));
...
extern struct CamToMonitor_t_MethodTblStruct CamToMonitor_t_MethodTbl ;
